...
void (UART0_IRQHandler)(void)
{
    ...
    uint32_t u32IntSrc = (((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->INTSTS;

    if (u32IntSrc & 0x11)   
    {
        while ((((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->FIFOSTS & (0x1ul << (14))) == 0) && (bufhead < 64))      
        {
            uart_rcvbuf[bufhead++] = (((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->DAT;
        }
    }
...
void PutString(void)
{
    ...
    for (i = 0; i < 64; i++)
    {
        ...
        (((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->DAT = response_buff[i];
    }
}
...
void ISP_UART_Init()
{
    ...
    (((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->FUNCSEL = (0x0ul << (0));
     
    (((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->LINE = (3ul) | (0x0ul << (3)) | (0x0ul << (2));
     
    (((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->FIFO = (0x3ul << (4)) | (0x3ul << (16));
     
    (((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->BAUD = (((0x1ul << (29)) | (0x1ul << (28))) | (((((12000000UL)) + ((115200)/2ul)) / (115200))-2ul));
     
    (((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->TOUT = ((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->TOUT & ~(0xfful << (0))) | (0x40);
    NVIC_SetPriority((UART0_IRQn), 2);
    NVIC_EnableIRQ((UART0_IRQn));
     
    (((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->INTEN = ((0x1ul << (11)) | (0x1ul << (4)) | (0x1ul << (0)));
}
