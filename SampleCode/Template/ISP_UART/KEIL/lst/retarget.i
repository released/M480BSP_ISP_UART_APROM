...
{
    while(((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->FIFOSTS & (0x1ul << (23)));

    if(ch == '\n')
    {
        ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->DAT = '\r';
        while(((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->FIFOSTS & (0x1ul << (23)));
    }
    ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->DAT = ch;
}
...
#line 585 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"
    while(1)
    {
        if((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->FIFOSTS & (0x1ul << (14))) == 0)
        {
            return (((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->DAT);
        }
    }
...
int kbhit(void)
{
    ...
    return !((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->FIFOSTS & (0x1ul << (14))) == 0);
...
int IsDebugFifoEmpty(void)
{
    ...
    return ((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL))->FIFOSTS & (0x1ul << (28))) != 0);
